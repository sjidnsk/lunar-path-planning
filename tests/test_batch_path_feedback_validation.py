...
class BatchPathFeedbackValidationTests(unittest.TestCase):
    ...
    def test_policy_canary_opportunity_quality_matrix_is_accepted(self) -> None:
        matrix = self._write_matrix(
            {
                "schema_version": "path-feedback-batch-matrix/v1",
                "runs": [
                    {
                        "run_id": "policy-canary-opportunity-quality-k3",
                        "scenario_set": "policy_canary_opportunity_quality",
                        "diagnostic_profile": "execution",
                        "top_k": 3,
                    }
                ],
