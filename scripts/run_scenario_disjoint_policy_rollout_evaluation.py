...
def _decision_record(
    ...
    *,
    ...
    return {
        ...
        "source_selected_policy_target_cell": source.get("policy_target_cell"),
        "raw_policy_selected_policy_target_cell": raw_policy.get("policy_target_cell"),
        "policy_selected_policy_target_cell": controlled.get("policy_target_cell"),
        "source_selected_execution_goal_cell": source.get("execution_goal_cell"),
        "raw_policy_selected_execution_goal_cell": raw_policy.get("execution_goal_cell"),
        "policy_selected_execution_goal_cell": controlled.get("execution_goal_cell"),
        ...
        "policy_selected_utility_delta": _delta(controlled.get("utility"), source.get("utility")),
        "raw_policy_selected_path_cost_delta": _delta(raw_policy.get("path_cost"), source.get("path_cost")),
        "raw_policy_selected_risk_delta": _delta(raw_policy.get("risk"), source.get("risk")),
        "raw_policy_selected_utility_delta": _delta(raw_policy.get("utility"), source.get("utility")),
