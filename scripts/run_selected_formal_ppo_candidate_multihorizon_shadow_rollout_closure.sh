...
OUTPUT="${OUTPUT:-outputs/path_feedback_batch_selected_formal_ppo_candidate_multihorizon_shadow_rollout_v1}"
CONFIG="${CONFIG:-configs/selected_formal_ppo_candidate_multihorizon_shadow_rollout_v1.json}"

rm -rf "$REPO_ROOT/$OUTPUT"

PYTHON="$PYTHON_BIN" bash "$SCRIPT_DIR/run_selected_formal_ppo_candidate_multihorizon_shadow_rollout.sh" \
